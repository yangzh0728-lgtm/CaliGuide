...
export const BLOG_ARTICLES: BlogArticle[] = [
  ...
  },
  {
    ...
    body: [
      ...
      "Weeks 2 to 3, use your address: Once mail reaches your address, the documents it generates can unlock later steps. Apply for a driver license or state ID and decide whether you need REAL ID. Enroll children in the district covering your residential address. Research health coverage, because moving to California may open a special enrollment period. Set up utilities and internet.",
      "Week 4, find your blockers: Instead of working through a checklist, ask what each unfinished task is waiting on. A stalled REAL ID application may mean you have one proof of address rather than two. A stalled job offer may involve work authorization rather than the SSN card itself. Repeated housing rejections may reflect missing US credit history rather than income. Name the blocker before asking anyone for help.",
      "Safety items for month one: California has hazards that may be unfamiliar. Learn what to do during an earthquake and how wildfire evacuation warnings and orders work. Learn that California wage and workplace safety protections apply regardless of immigration status. Learn that a notario is not a lawyer in the United States, because that misunderstanding can cause serious harm.",
      "Common sequencing mistakes: Opening a bank account before having a US address or phone number, booking a DMV appointment before any mail proves residency, assuming a Social Security Number by itself grants work authorization, collecting only one proof of address before applying for REAL ID, waiting for permanent housing before joining the SSN appointment queue, paying anyone who claims they can speed up a government process",
      "Official reminder: This guide covers sequencing only. Requirements, deadlines, and eligibility depend on your immigration status, county, and current policy. Confirm every step against the relevant detailed guide and its official sources before you act.",
    ],
  },
  {
    id: "trending-ssn",
    ...
    body: [
      ...
      "Common mistakes: Assuming an SSN proves work authorization, bringing only photocopies, paying an agent for a free SSA service, using a false or borrowed number, submitting duplicate applications, relying on unofficial appointment reports, or sending identity documents to an unverified person or website",
      "Official reminder: Eligibility and document requirements depend on citizenship, immigration status, work authorization, age, and the type of request. Use SSA's Number and Card tool for a personalized path and confirm current instructions directly with Social Security before submitting documents.",
    ],
  },
  {
    id: "guide-moving-address-checklist",
    ...
    body: [
      "Who this is for: People moving to a new address within California and California residents moving into or out of the state. It separates federal duties, California deadlines, and provider updates so you can handle urgent records before routine accounts.",
      "Deadline table: Use the checklist below as your control center. Government deadlines apply only when the agency and rule cover your situation; provider timing is practical guidance rather than a legal deadline. Keep every confirmation until mail and account records show the new address.",
      "Before moving day: Submit USPS mail forwarding through the official USPS site or at a Post Office, schedule utility stop and start dates, and update your employer or payroll portal before the next pay cycle. Forwarding is a safety net, not a substitute for telling each organization directly.",
      "Within 10 days: Most noncitizens must report a new address to USCIS within 10 days, subject to USCIS exceptions. USPS forwarding does not update USCIS, and USPS says it will not forward USCIS mail. California DMV also requires an address update within 10 days. Check your driver license or ID and each vehicle, vessel, or placard record separately rather than assuming one record updated everything. Eligible California voters should confirm their registration address before the next election deadline.",
      "Within two weeks: Update banks, credit cards, lenders, auto insurance, renters insurance, health coverage, medical providers, and any tax correspondence address. Tell your auto insurer where the vehicle is principally garaged; location is used in California auto-insurance rating and records. Use IRS Form 8822 when you need to notify the IRS of a home mailing-address change.",
      "Utilities and services: Confirm electricity, gas, water, trash, internet, mobile phone, home security, subscriptions, schools, childcare, pet licensing, parking permits, toll accounts, and delivery profiles. Record final meter readings where available, return rented equipment, and check the first and final bills for overlapping charges.",
      "Usually unnecessary: You generally do not change an address for the Social Security card itself. If you receive Social Security benefits or Medicare, update the mailing address through the procedure SSA provides. SSI recipients follow different reporting steps and should report relevant address or living-arrangement changes promptly. Account-security phone numbers for Login.gov or ID.me may also be separate from SSA benefit contact information.",
      "Protect yourself while moving: Use only USPS.com for mail forwarding; third-party sites may charge much more than the official authentication fee. Secure mail during the transition, update card billing addresses before large purchases, use unique passwords, and save screenshots, receipts, case numbers, and effective dates. Never pay with gift cards or cryptocurrency to change a government address.",
      "Common sequencing mistakes: Treating USPS forwarding as notice to USCIS, updating a DMV license but not vehicle records, waiting until after moving to schedule utilities, forgetting the auto-insurance garaging address, changing a bank mailing address but not the card billing address, discarding confirmation numbers, or assuming voter registration updated without checking",
      "Official reminder: Address rules depend on immigration status, benefit type, move direction, election timing, and the records you hold. Confirm current requirements through USPS, USCIS, California DMV, SSA, IRS, your election office, and each service provider before relying on this checklist.",
    ],
  },
  {
    id: "trending-banking",
  ...
  {
    id: "guide-earthquake-wildfire-preparedness",
    title: "加州地震与山火应急准备",
    category: "Safety",
    ...
    body: [
      ...
      "烟雾出现时查看 AirNow 的 AQI 和 Fire and Smoke Map。减少户外活动，尽量保持室内空气清洁；有心肺疾病、儿童、老人或孕妇的家庭应提前向医疗人员了解个人防护计划。",
  ...
  },
  {
    ...
    title: "警惕 Notario 移民服务欺诈",
    category: "Legal",
    image: "https://images.unsplash.com/photo-1450101499163-c8848c66ca85?auto=format&fit=crop&w=1200&q=80",
    createdAt: "August 27, 2026",
    readTime: "9 min read",
    tags: ["Notario", "移民欺诈", "法律帮助", "律师查询", "移民服务"],
    ...
    body: [
      ...
      "如果怀疑被骗，不要让对方继续控制账户、邮箱或案件文件。尽快从合格律师或认可机构取得独立意见，保存广告和通信记录，并根据情况联系州律师协会、州总检察长或相关移民机构投诉。",
