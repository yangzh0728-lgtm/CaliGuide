...
const GUIDE_CITATION_CONFIGS: Record<string, GuideCitationConfig> = {
  ...
  "forum-first-30-days": {
    referenceIds: ["california-services", "211-california", "dmv-new-residents", "uscis-address-change"],
    sectionCitationIds: [
      ["california-services"],
      ["dmv-new-residents", "california-services"],
      ["211-california", "california-services"],
      ["211-california", "uscis-address-change"],
    ],
  },
  "trending-ssn": {
