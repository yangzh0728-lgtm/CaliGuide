          ...
          messages: [
            {
              ...
              image_urls: ["https://cdn.example.com/chat/dmv.png"],
    ...
    expect(memory.messages).toEqual([
      {
        ...
        content: "DMV checklist",
        timestamp: "04:01 AM",
        imageUrls: ["https://cdn.example.com/chat/dmv.png"],
      },
    ...
    expect(
      buildChatMessageInserts("session-1", "user-1", [
        { role: "user", content: "Hello", timestamp: "9:00 AM" },
        {
          ...
          content: "Hi",
          timestamp: "9:01 AM",
          imageUrls: ["https://cdn.example.com/chat/answer.png"],
        },
      ]),
    ).toEqual([
      { session_id: "session-1", user_id: "user-1", role: "user", content: "Hello", image_urls: [] },
      {
        session_id: "session-1",
        user_id: "user-1",
        role: "bot",
        content: "Hi",
        image_urls: ["https://cdn.example.com/chat/answer.png"],
      },
    ]);
  });
});
